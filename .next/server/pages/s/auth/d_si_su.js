...
class index extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  constructor(props) {
    ...
    _defineProperty(this, "resend", type => {
      ...
      _functions_functions__WEBPACK_IMPORTED_MODULE_11__[/* sendVerification */ "z"].call(this, this.state.userDetails.userID, type, 'storeAndSend', 'nocode', this.state.userDetails.phoneNumber, this.state.userDetails.email, this.state.userDetails.firstName);
    });
        ...
        children: [/*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__["jsx"])("a", {
          ...
          children: [/*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__["jsxs"])("div", {
            ...
            onClick: () => {
              if (this.state.newEmail.length == 0) this.setState({
                ...
                _functions_functions__WEBPACK_IMPORTED_MODULE_11__[/* changeEmailOrPhoneNumber */ "d"].call(this, 'email', this.state.userDetails.userID, '', this.state.newEmail);
              });
            },
            ...
            onClick: () => {
              if (this.state.newPhoneNumber.length == 0) this.setState({
                ...
                axios__WEBPACK_IMPORTED_MODULE_7___default.a.post(`https://us-central1-perch-01.cloudfunctions.net/checkIfPhoneNumberIsFree`, {
                  ...
                  if (r.data) {
                    _functions_functions__WEBPACK_IMPORTED_MODULE_11__[/* changeEmailOrPhoneNumber */ "d"].call(this, 'phoneNumber', this.state.userDetails.userID, `+${this.state.countryCode}${this.state.newPhoneNumber}`, '');
                  } else this.setState({
                    error: true,
          ...
          onClick: () => {
            this.setState({
              ...
              _functions_functions__WEBPACK_IMPORTED_MODULE_11__[/* signOut */ "B"].call(this, true);
            });
          },
          children: /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__["jsx"])("p", {
              ...
              onClick: () => {
                if (!this.state.verificationPhoneLoader) {
                  if (this.state.phoneVerificationCode.length != 6) this.setState({
                    ...
                    _functions_functions__WEBPACK_IMPORTED_MODULE_11__[/* sendVerification */ "z"].call(this, this.state.userDetails.userID, 'phoneNumber', 'check', this.state.phoneVerificationCode, this.state.userDetails.phoneNumber, this.state.userDetails.email, this.state.userDetails.firstName);
                  });
                }
              },
              ...
              onClick: () => {
                if (!this.state.verificationEmailLoader) {
                  if (this.state.emailVerificationCode.length != 6) this.setState({
                    ...
                    _functions_functions__WEBPACK_IMPORTED_MODULE_11__[/* sendVerification */ "z"].call(this, this.state.userDetails.userID, 'email', 'check', this.state.emailVerificationCode, this.state.userDetails.phoneNumber, this.state.userDetails.email, this.state.userDetails.firstName);
                  });
                }
              },
            ...
            children: [/*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__["jsx"])("p", {
              ...
              onClick: () => {
                if (!this.state.loading) {
                  ...
                  });else _functions_functions__WEBPACK_IMPORTED_MODULE_11__[/* sendPasswordResetLink */ "x"].call(this, this.state.email);
                }
              },
            ...
            children: [/*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__["jsx"])("p", {
              ...
              onClick: () => {
                if (!this.state.loading) {
                  ...
                  });else _functions_functions__WEBPACK_IMPORTED_MODULE_11__[/* signIn */ "A"].call(this, this.state.email, this.state.password, 'driver');
                }
              },
              children: this.state.loading ? /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__["jsx"])(react_loader_spinner__WEBPACK_IMPORTED_MODULE_12___default.a, {
                type: "TailSpin",
            ...
            onClick: () => {
              if (!this.state.loading) {
                if (this.state.firstName == '') this.setState({
                  ...
                  confirmPassword: ''
                });else _functions_functions__WEBPACK_IMPORTED_MODULE_11__[/* signUp */ "C"].call(this, this.state.firstName, this.state.lastName, this.state.email1, this.state.countryCode, this.state.phoneNumber, this.state.password1, true, this.state.referralCode);
              }
            },
            children: this.state.loading ? /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__["jsx"])(react_loader_spinner__WEBPACK_IMPORTED_MODULE_12___default.a, {
              type: "TailSpin",
