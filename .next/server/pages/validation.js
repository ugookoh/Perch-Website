...
class index extends react__WEBPACK_IMPORTED_MODULE_3___default.a.Component {
  ...
  componentDidMount() {
    if (this.props.mode == 'verifyEmail' && this.props.email) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_11___default.a.post(`https://us-central1-perch-01.cloudfunctions.net/findUidByEmail`, {
        formattedEmail: Object(_functions_functions__WEBPACK_IMPORTED_MODULE_8__[/* emailFormat */ "f"])(email, 'emailToString')
      }).then(r => {
